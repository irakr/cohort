...
//!   the detector daemon.
//! - Files/directories: the working directories the machine's interactive
//!   shells (found via the process table) and the agents above are actually
//!   in, capped at MAX_DIR_SUGGESTIONS.
